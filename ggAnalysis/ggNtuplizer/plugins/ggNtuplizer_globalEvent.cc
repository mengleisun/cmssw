...
void ggNtuplizer::fillGlobalEvent(const edm::Event& e, const edm::EventSetup& es) {
  ...
  for (size_t i = 0; i < trgNames.size(); ++i) {
    ...
    else if (name.find("HLT_Ele12_CaloIdL_TrackIdL_IsoVL_v")                != string::npos) bitEleMuX =  7;
    else if (name.find("HLT_Ele23_CaloIdL_TrackIdL_IsoVL_v")                != string::npos) bitEleMuX =  8;
    else if (name.find("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v")             != string::npos) bitEleMuX =  9;
    else if (name.find("HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v")           != string::npos) bitEleMuX = 10;
    else if (name.find("HLT_Mu27_TkMu8_v")                                  != string::npos) bitEleMuX = 11;
    else if (name.find("HLT_DoubleIsoMu17_eta2p1_v")                        != string::npos) bitEleMuX = 12;
    else if (name.find("HLT_IsoMu24_eta2p1_v")                              != string::npos) bitEleMuX = 13;
    else if (name.find("HLT_IsoMu27_v")                                     != string::npos) bitEleMuX = 14;
    else if (name.find("HLT_Mu45_eta2p1_v")                                 != string::npos) bitEleMuX = 15;
    else if (name.find("HLT_Mu55_v")                                        != string::npos) bitEleMuX = 16;
    else if (name.find("HLT_IsoMu17_eta2p1_v")                              != string::npos) bitEleMuX = 17;
    else if (name.find("HLT_IsoMu18_v")                                     != string::npos) bitEleMuX = 18;
    else if (name.find("HLT_IsoMu20_v")                                     != string::npos) bitEleMuX = 19;
    else if (name.find("HLT_Mu17_v")                                        != string::npos) bitEleMuX = 20;
    else if (name.find("HLT_Mu20_v")                                        != string::npos) bitEleMuX = 21;
    else if (name.find("HLT_Mu8_TrkIsoVVL_v")                               != string::npos) bitEleMuX = 22;
    else if (name.find("HLT_IsoMu22_v")                                     != string::npos) bitEleMuX = 23;
    else if (name.find("HLT_Mu17_TkMu8_DZ_v")                               != string::npos) bitEleMuX = 24;
    else if (name.find("HLT_Mu8_DiEle12_CaloIdL_TrackIdL_v")                != string::npos) bitEleMuX = 25;
    else if (name.find("HLT_DiMu9_Ele9_CaloIdL_TrackIdL_v")                 != string::npos) bitEleMuX = 26;
    else if (name.find("HLT_Mu17_Photon30_CaloIdL_L1ISO_v")                 != string::npos) bitEleMuX = 27;
    else if (name.find("HLT_Mu17_Photon35_CaloIdL_L1ISO_v")                 != string::npos) bitEleMuX = 28;
    else if (name.find("HLT_Ele22_eta2p1_WPLoose_Gsf_LooseIsoPFTau20_v")    != string::npos) bitEleMuX = 29;
    else if (name.find("HLT_IsoMu17_eta2p1_LooseIsoPFTau20_v")              != string::npos) bitEleMuX = 30;
    else if (name.find("HLT_Ele27_WPLoose_Gsf_v")                           != string::npos) bitEleMuX = 31;
